<?
$Marketplace_Logo_Src = "/img/svg/marketplace-logo.svg";
$_HTML_TITLE = "Marketplace";
include("_header.php");
?>
    ...
    <main role="main">
      ...
      <article>
        <header class="section background-primary text-center">
            <h1 class="text-white margin-bottom-10 text-size-50 text-thin text-line-height-1">
              <?=$_HTML_TITLE?>
            </h1>
            <h1 class="text-italic text-white margin-bottom-15 text-size-16 text-thin text-line-height-1">
              Develop.... Publish... Attract...
            </h1>
            <img style="position: absolute; left: 50%;" src="<?=$Marketplace_Logo_Src?>"/>
        </header>
