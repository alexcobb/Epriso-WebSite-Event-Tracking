          ...
          <div class="carousel-fade-transition owl-carousel carousel-main carousel-nav-white carousel-wide-arrows">
            <div class="item">
              <div class="s-12 center">
                <img src="img/Carousel/sales.png" alt="">
                <div class="carousel-content">
                  <div class="padding-2x">
                    <div class="s-12 m-12 l-8">
                      <p class="text-white text-s-size-20 text-m-size-40 text-l-size-60 margin-bottom-40 text-thin text-line-height-1">Sales</p>
            ...
            <div class="item">
              <div class="s-12 center">
                <img src="img/Carousel/marketing.png" alt="">
                <div class="carousel-content">
                  <div class="padding-2x">
                    <div class="s-12 m-12 l-8">
                      <p class="text-white text-s-size-20 text-m-size-40 text-l-size-60 margin-bottom-40 text-thin text-line-height-1">Marketing</p>
            ...
            <div class="item">
              <div class="s-12 center">
                <img src="img/Carousel/service.png" alt="">
                <div class="carousel-content">
                  <div class="padding-2x">
                    <div class="s-12 m-12 l-8">
                      <p class="text-white text-s-size-20 text-m-size-40 text-l-size-60 margin-bottom-40 text-thin text-line-height-1">Service</p>
                      <p class="text-white text-size-16 margin-bottom-30"></p>
                    </div>                  
                  </div>
                </div>
            ...
            <div class="item">
              <div class="s-12 center">
                <img src="img/svg/accelerate.svg" alt="">
                <div class="carousel-content">
                  <div class="padding-2x">
                    <div class="s-12 m-12 l-8">
            ...
            <div class="item">
              <div class="s-12 center">
                <img src="img/Carousel/academy.png" alt="">
                <div class="carousel-content">
                  <div class="padding-2x">
                    <div class="s-12 m-12 l-8">
                      <p class="text-white text-s-size-20 text-m-size-40 text-l-size-60 margin-bottom-40 text-thin text-line-height-1">Academy</p>
                      <p class="text-white text-size-16 margin-bottom-30"></p>
                    </div>                  
                  </div>
                </div>
            ...
            <div class="item">
              <div class="s-12 center">
                <img src="https://marketplace.creatio.com/sites/marketplace/files/1920.png" alt="">
                <div class="carousel-content">
                  <div class="padding-2x">
                    <div class="s-12 m-12 l-8">
                      <p class="text-white text-s-size-20 text-m-size-40 text-l-size-60 margin-bottom-40 text-thin text-line-height-1">Marketplace</p>
                      <p class="text-white text-size-16 margin-bottom-30"></p>    
                    </div>                  
                  </div>
                </div>
